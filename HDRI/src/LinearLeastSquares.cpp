...
auto HDRI::LinearLeastSquares::solver(const std::vector<std::vector<int>> &Z, const std::vector<double> &deltaT,
                                      const WeightFunction &wf, int lambda) -> cv::Mat { // zij , shutter , w, g, lE
